            ...
            <div class="row">
              ...
              <div class="col-6 ">
                <div class="form-group">
                  ...
                  {{-- <span class="text-danger">*</span> --}}
                  <input type="text" id="home_phone" name="home_phone" class="form-control phones"   />
                </div>
              </div>
              <div class="col-6 ">
                <div class="form-group">
                  ...
                  {{-- <span class="text-danger">*</span> --}}
                  <input type="text" id="cell_phone" name="cell_phone" class="form-control phones"   />
                </div>
              </div>
              <div class="col-6 ">
                <div class="form-group">
              ...
              <div class="col-6 ">
                <div class="form-group">
                  ...
                  {{-- <span class="text-danger">*</span> --}}
                  <input type="input" autocomplete="0" id="date_of_birth" name="date_of_birth" class="form-control dates"   />
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-6 ">
                <div class="form-group">
                  ...
                  {{-- <span class="text-danger">*</span> --}}
                  <input type="text" id="zip" name="zip" class="form-control zips "   />
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-3 ">
                <div class="form-group d-flex">
                    <input type="checkbox" value="1" id="high_blood_pressure" name="high_blood_pressure" class="form-control"   />
                    <label for="high_blood_pressure" class="mb-0">High Blood Pressure</label>
                </div>
              </div>
              <div class="col-3 ">
                <div class="form-group d-flex">
                    <input type="checkbox" value="1" id="high_cholesterol" name="high_cholesterol" class="form-control"   />
                    <label for="high_cholesterol" class="mb-0">High Cholesterol</label>
                </div>
              </div>
              <div class="col-3 ">
                <div class="form-group d-flex">
                    <input type="checkbox" value="1" id="diabetes" name="diabetes" class="form-control"   />
            ...
            <div class="row">
              ...
              <div class="col-12 ">
                <div class="form-group">
                     <textarea  id="patient_note" name="patient_note" class="form-control"  ></textarea>
                </div>
              </div>
            </div>
