  ...
  <div class="page-content container container-plus">
    ...
    <div class="page-header pb-2">
      <h2 class="page-title text-primary-d2 text-150">
        <a href="{{url('settings/edit/clinic-info')}}" >{{ $page_name ?? "" }}</a>
    ...
    <div class="cards-container mt-3">
      <div class="card border-0 shadow-sm radius-0">
        ...
        <div class="card-body px-2 py-0 pb-2 border-1 brc-primary-m3 border-t-0">
          <form class="mt-lg-3 forms" autocomplete="off" method="POST" action="{{url('settings/edit/clinic-info/'.session('current_location')->id)}}" >
            @csrf
            ...
            <div class="row">
              <div class="col12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="url" id="website" name="website" class="form-control" value="{{ old('website', $location->website)}}" required />
                </div>
              </div>
              <div class="col12 col-md-6">
                <div class="form-group">
