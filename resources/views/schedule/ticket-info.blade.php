          ...
          <div class="col-12">
            <div class="card card-primary ">
                <div class="card-body p-2">
                  <a href="{{route('appointment.cancel',['appointment' => $appointment->id])}}" class="btn btn-success my-1">Reschedule / Cancellation</a>
                  <a href="{{route('appointment.edit',['appointment' => $appointment->id])}}"   class="btn btn-success my-1">Covert Back to Appointment <i class="fas fa-sign-out-alt"></i></a>
          ...
          <div class="col-12 mt-2">
                <div class="card border-0 shadow-sm radius-0 my-2">
                        ...
                        <div class="card-body px-2 py-2 pb-2 border-1 brc-primary-m3 border-t-0">
                            ...
                            <form action="{{route('ticket-info.store',['appointment' => $appointment->id])}}" class="forms" enctype="multipart/form-data" method="post">
                                @csrf
                            <div class="d-flex flex-column justify-content-start align-items-center">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 d-flex align-items-center">
                                              <input type="checkbox" name="services[]" value="{{$s->id}}" data-price="{{$s->price}}" class="form-control">
                                        ...
                                        <label   class="col-sm-2 col-form-label">Select Package(s) Sold</label>
                                                ...
                                                <table class="table table-bordered table-hover  w-100">
                                                    ...
                                                    <tbody id="products-rows" data-products='{{json_encode($products)}}' data-store='{{route('product.store')}}' data-token="{{csrf_token()}}">
                                                        ...
                                                        <tr class="bg-light">
                                                            <td  colspan="4"><small>No Sold Items dectected, Press the 'Add' button below to get started</small></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                              <input  name="total" type="number" value="" step='any' placeholder="$0.00"    readonly  class="form-control w-200px">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 d-flex align-items-end mt-2">
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                              <input type="number" id="apdov" autocomplete="off" value="0" name="amount_paid_during_office_visit" value="" class="form-control w-200px">
                                        </div>
                                    </div>
                                    <div class="form-group row">
