...
@section('content')
    ...
    <div role="main" class="main-content">
      ...
      <div class="page-content container container-plus">
        ...
        <div class="row mt-3 ">
        <div class="col-12 ">
                <div class="cards-container w-100 my-3">
                <div class="card border-0 w-100 shadow-sm radius-0">
                    ...
                    <div class="card-body px-2 py-0 pb-2 border-1 brc-primary-m3 border-t-0 pt-2">
                        <div class="table-responsive dashboard">
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <tr class="text-180 text-secondary-d4">
                                        <td>{{$monthly_sales}}</td>
                                        <td>{{$monthly_avg_ticket}}</td>
                                        <td> {{$monthly_down_payment}}</td>
                                        <td>{{$monthly_avg_down}}</td>
                                        <td> {{$monthly_patients}}</td>
                                        <td>{{$monthly_collections}}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <tr class="text-180 text-secondary-d4">
                                        <td>{{$daily_sales}}</td>
                                        <td>{{$daily_avg_ticket}}</td>
                                        <td> {{$daily_down_payment}}</td>
                                        <td>{{$daily_avg_down}}</td>
                                        <td> {{$daily_patients}}</td>
                                        <td>{{$daily_collections}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
