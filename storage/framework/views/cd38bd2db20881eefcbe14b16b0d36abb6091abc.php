  ...
  <div class="page-content container container-plus">
    ...
    <div class="page-header pb-2">
      <h2 class="page-title text-primary-d2 text-150">
        <a href="<?php echo e(url('settings/locations')); ?>" >Locations</a>
    ...
    <div class="cards-container mt-3">
      <div class="card border-0 shadow-sm radius-0">
        ...
        <div class="card-body px-2 py-0 pb-2 border-1 brc-primary-m3 border-t-0">
          <form class="mt-lg-3 forms" method="POST" action="<?php echo e(url('settings/add-location')); ?>">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col12 col-md-6">
                <div class="form-group">
                  <label for="location_name" class="mb-0">Location Name</label>
                  <input type="text" id="location_name" name="location_name" class="form-control" required value="<?php echo e(old('location_name')); ?>" />
                </div>          
              </div>
              <div class="col12 col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col12 col-md-2">
                <div class="form-group">
                  ...
                  <input type="text" id="zip" name="zip" class="form-control"  value="<?php echo e(old('zip')); ?>"  required/>
                </div>   
              </div>  
            </div>
            ...
            <div class="row">
              <div class="col12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="url" id="website" name="website" class="form-control"  value="<?php echo e(old('website')); ?>" />
                </div> 
              </div> 
              <div class="col12 col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="phone" name="phone" class="form-control phones"  value="<?php echo e(old('phone')); ?>"  placeholder="(___) ___-____" required />
                </div>  
              </div>
              <div class="col12 col-md-6">
                <div class="form-group">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GithubRepository\pryapus\resources\views/locations/create.blade.php ENDPATH**/ ?>