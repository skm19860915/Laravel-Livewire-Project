    ...
    <div class="cards-container mt-3">
      <div class="card border-0 shadow-sm radius-0">
        ...
        <div class="card-body px-2 py-0 pb-2 border-1 brc-primary-m3 border-t-0">
          <form class="mt-lg-3 forms" autocomplete="off" method="POST" action="<?php echo e(url('settings/update-location')); ?>" >
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
              <div class="col12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="url" id="website" name="website" class="form-control" value="<?php echo e(old('website', $location->website)); ?>"  />
                </div> 
              </div> 
              <div class="col12 col-md-6">
                <div class="form-group">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GithubRepository\pryapus\resources\views/locations/edit.blade.php ENDPATH**/ ?>