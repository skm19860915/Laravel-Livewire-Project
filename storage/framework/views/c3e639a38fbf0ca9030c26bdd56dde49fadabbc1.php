  ...
  <div class="page-content container container-plus">
    <div class="page-header pb-2">
      <h2 class="page-title text-primary-d2 text-150">
        ...
        <small class="page-info text-secondary-d2 text-nowrap"><i class="fa fa-angle-double-right text-80"></i>&nbsp;Add New Email Journey</small>
      </h2>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
              <div class="col12 col-md-12 text-left pt-2">
                <button class="btn btn-primary px-4 submit-buttons" wire:click="saveTemplate">Save</button>
              </div>
            </div>
        </div>
      </div>
...
<?php /**PATH D:\GithubRepository\pryapus\resources\views/livewire/create-email.blade.php ENDPATH**/ ?>