      ...
      <div class="cards-container mt-3">
        <div class="card border-0 shadow-sm radius-0">
          ...
          <div class="card-body bgc-transparent px-2 py-0 pb-2 border-1 brc-primary-m3 border-t-0 table-responsive">
            ...
            <a href="<?php echo e(url('/create/patient')); ?>" class="btn btn-success mt-1 mb-1"><i class="fa fa-plus mr-1"></i>Add New Patient</a>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GithubRepository\pryapus\resources\views/patient/index.blade.php ENDPATH**/ ?>